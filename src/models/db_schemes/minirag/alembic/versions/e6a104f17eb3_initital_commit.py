...
Revision ID: e6a104f17eb3
Revises: 
Create Date: 2026-07-24 19:14:27.230652
...
def upgrade() -> None:
    ...
    sa.Column('asset_created_at', sa.DateTime(timezone=True), server_default=sa.text('now()'), nullable=False),
    ...
    op.create_index('ix_asset_type', 'assets', ['asset_project_id'], unique=False)
    ...
    sa.Column('chunk_updated_at', sa.DateTime(timezone=True), nullable=True),
